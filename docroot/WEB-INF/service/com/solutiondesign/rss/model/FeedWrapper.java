...
public class FeedWrapper implements Feed, ModelWrapper<Feed> {
	...
	*/
	...
	@Override
	public int compareTo(com.solutiondesign.rss.model.Feed feed) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.solutiondesign.rss.model.Feed> toCacheModel() {
		return _feed.toCacheModel();
	}

	@Override
	public com.solutiondesign.rss.model.Feed toEscapedModel() {
		return new FeedWrapper(_feed.toEscapedModel());
	}

	@Override
	public com.solutiondesign.rss.model.Feed toUnescapedModel() {
