 ...
 */
%>
<portlet:resourceURL var="userGroupsActivitiesURL" id="getUserGroupsActivities" />
...
SDG.RssPortlet.UserGroupsActivitiesURL = "${userGroupsActivitiesURL}";
SDG.RssPortlet.ShowActivities = "${showActivities}";
</script>